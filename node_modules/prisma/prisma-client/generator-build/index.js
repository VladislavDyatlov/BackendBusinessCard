...
// ../../node_modules/.pnpm/@prisma+engines-version@5.1.0-8.b182127de581d0bf6ec89152a6e2fb4652be0f0a/node_modules/@prisma/engines-version/package.json
var require_package = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@5.1.0-8.b182127de581d0bf6ec89152a6e2fb4652be0f0a/node_modules/@prisma/engines-version/package.json"(exports, module2) {
    module2.exports = {
      ...
      prisma: {
        enginesVersion: "b182127de581d0bf6ec89152a6e2fb4652be0f0a"
      },
      repository: {
        type: "git",
...
// ../../node_modules/.pnpm/@prisma+engines-version@5.1.0-8.b182127de581d0bf6ec89152a6e2fb4652be0f0a/node_modules/@prisma/engines-version/index.js
var require_engines_version = __commonJS({
  "../../node_modules/.pnpm/@prisma+engines-version@5.1.0-8.b182127de581d0bf6ec89152a6e2fb4652be0f0a/node_modules/@prisma/engines-version/index.js"(exports) {
    "use strict";
...
function getReturnType({
  ...
  if (isList || hideCondition) {
    ...
    return `${promiseOpen}$Types.GetResult<${getPayloadName(name)}<ExtArgs>, T, '${actionName}'>${isChaining ? " | Null" : ""}${promiseClose}`;
  }
...
var MinimalArgsType = class {
  constructor(args, type, context, action, generatedTypeName = getModelArgName(type.name, action)) {
    this.args = args;
    this.type = type;
    this.context = context;
    this.action = action;
...
`;
    ...
    const modelTypeExport = moduleExport(
      typeDeclaration(
        model.name,
        namedType(`runtime.Types.DefaultSelection`).addGenericArgument(namedType(getPayloadName(model.name)))
      )
...
var DefaultArgsAliases = class {
  ...
  generateAliases(dmmf2) {
    const aliases = [];
    for (const modelName of Object.keys(dmmf2.typeAndModelMap)) {
...
`;
  ...
  toTS(edge = false) {
    ...
    for (const enumType of this.dmmf.schema.enumTypes.model ?? []) {
      const namespacedType = namedType(`$Enums.${enumType.name}`);
      modelEnums.push(new Enum(enumType, false).toTS());
      modelEnumsAliases.push(
        stringify(moduleExport(typeDeclaration(enumType.name, namespacedType))),
        stringify(moduleExport(constDeclaration(enumType.name, namespacedType)))
      );
    }
